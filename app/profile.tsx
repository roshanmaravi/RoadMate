          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={styles.menuLeft}>
              <View style={[styles.iconCircle, { backgroundColor: '#F3E5F5' }]}>
                <Ionicons name="car-outline" size={22} color="#9C27B0" />
              </View>
              <View>
                <Text style={styles.menuLabel}>My Rides</Text>
                <Text style={styles.menuSubtext}>View booked & posted rides</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#999" />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={styles.menuLeft}>
              ...
              <View>
                ...
                <Text style={styles.menuSubtext}>Past completed rides</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#999" />
          </TouchableOpacity>
